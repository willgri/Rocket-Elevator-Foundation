class Lead < ApplicationRecord
    ...
    def upload_the_file
        ...
        ActiveRecord::Base.connection.execute("UPDATE Rocket_Elevators_API.leads SET attached_file = null WHERE id='#{self.id}';")
    ...
    def manage_dropbox_after_create
        ...
        Customer.all.each do |c|
            ...
            if c.business_name == self.business_name
                ...
                ActiveRecord::Base.connection.execute("UPDATE Rocket_Elevators_API.leads SET customer_id =#{c.id} WHERE id = #{self.id};")
